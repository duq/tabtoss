<x-layouts.focus-center class="md:max-w-6xl! mx-auto overflow-x-hidden relative" :backButton="false">
    ...
    <div class="mx-auto md:max-w-6xl text-center mt-8">
        <div class="mx-4">
            ...
            <div class="mx-auto my-8 rounded-2xl border border-neutral-200 bg-linear-to-b from-primary-50 to-from-primary-100 p-6 shadow-sm md:max-w-2xl">
                <div>
                    ...
                    <div class="flex flex-wrap md:flex-nowrap gap-3 items-center justify-center mt-4">
                        <label class="flex h-10 w-full items-center gap-2 rounded-xl border border-neutral-300 bg-white px-3 md:w-72">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4 opacity-70"><path d="M2.5 3A1.5 1.5 0 0 0 1 4.5v.793c.026.009.051.02.076.032L7.674 8.51c.206.1.446.1.652 0l6.598-3.185A.755.755 0 0 1 15 5.293V4.5A1.5 1.5 0 0 0 13.5 3h-11Z" /><path d="M15 6.954 8.978 9.86a2.25 2.25 0 0 1-1.956 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z" /></svg>
                            <input type="text" class="h-full w-full bg-transparent text-sm text-neutral-900 placeholder:text-neutral-500 focus:outline-none" placeholder="{{ __('Your email')}}" />
                        </label>
